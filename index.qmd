---
title: "Workshop Exercise: Emissions Data - Table, Map, and Chart"_Victoria Shipanga
format: html
---
...
emissions_long_1990_2022 = emissions_long[(emissions_long['year'] >= 1990) & (emissions_long['year'] <= 2022)]

# Query for 5 countries (adjust these to any countries you like)
emissions_long_subset = selected_countries = ['Zambia', 'Angola', 'India', 'Namibia', 'Botswana']
emissions_five = emissions_long_1990_2022[emissions_long_1990_2022['country'].isin(selected_countries)]


# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(emissions_five, x="year", y="emissions", color="country", title='Emissions per year (1990-2022) for selected countries')
fig_chart.show()
